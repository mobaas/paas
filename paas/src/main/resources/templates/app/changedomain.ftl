...
<body>
   <form id="form1" action="/app/changedomain" method="post" style="padding: 20px">
	...
	<div class="layui-form-item">
        <label class="layui-form-label">现域名</label>
        <div class="layui-input-block">
            <input type="text" name="domain" readonly="readonly" autocomplete="off" class="layui-input" value="${app.domain}">
        </div>
    </div>
